const DATA = [
  {
    ...
    topics: [
      ...
      {
        page: "4",
        topic: "Design Systems. Mood Board -Figma",
      },
      {
        page: "5",
        topic: "Develop Frontend -React, Zustand",
      },
      {
        page: "7",
        topic: "Develop Backend -Python, PostgreSQL",
      },
      {
        page: "9",
        topic: "REST API Integration. OpenAI GPT-4.1 nano",
      },
      {
        page: "10",
        topic: "Automated Software Testing -Playwright",
      },
      {
        page: "11",
        topic: "CI/CD, DevOps -Azure App Services",
      },
      {
        page: "12",
        topic: "Agile Workflow -GitHub Projects",
      },
    ],
  },
  {
    title: "ML Data Engineering",
    subtitle: "Training Week 1/6",
    description:
