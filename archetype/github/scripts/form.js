...
Form.form.style.marginTop = "24px";
Form.form.style.padding = "4px 4px";
Form.form.style.width = "100%";
Form.form.style.height = "56px";
...
// Form.input.style.border = "1px solid";
Form.input.style.width = "100%";
Form.input.style.textAlign = "center";
Form.input.style.fontSize = "20px";
